document.addEventListener("DOMContentLoaded", function () {
    ...
    const cropCancelButton =
        document.getElementById("cropCancelButton");

    const cropConfirmButton =
        document.getElementById("cropConfirmButton");
    ...
    if (
        ...
        console.error(
            "Profile crop: required elements were not found."
        );
